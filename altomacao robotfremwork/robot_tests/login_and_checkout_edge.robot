...
*** Test Cases ***
Login on Saucedemo, Add Item to Cart, and Checkout
    [Documentation]    Este teste realiza o login no Saucedemo, adiciona o item "Sauce Labs Backpack" ao carrinho e navega para a página de checkout.
    ...
    SeleniumLibrary.Click Button    id=checkout  # Clica no botão de checkout
    BuiltIn.Sleep    999999  # Mantém a página do checkout aberta indefinidamente
